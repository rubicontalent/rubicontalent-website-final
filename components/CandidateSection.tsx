...
const candidateBullets = ["Confidential Advice", "Selective Introductions"];
    ...
    <section id="candidates" className="texture-section reveal-section py-16 md:py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-8 px-5 md:gap-12 md:px-8 lg:grid-cols-2">
        <div>
          ...
          <h2 className="section-title">Serious career moves, handled discreetly.</h2>
          <p className="section-copy">
            The right move should be considered, not rushed. We advise professionals on timing,
            positioning, and opportunities that fit their long-term direction.
          </p>
          <div className="mt-6 space-y-3 md:mt-8 md:space-y-4">
            {candidateBullets.map((item) => (
              <div key={item} className="flex items-center gap-3">
                ...
                <span className="text-base font-medium text-navy md:text-lg">{item}</span>
              </div>
            ))}
          </div>
